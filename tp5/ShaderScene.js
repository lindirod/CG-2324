...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/our_sepia.frag"),
		...
		this.testShaders[11].setUniformsValues({ water: 1 });
	...
	update(t) {
		...
		if (this.selectedExampleShader == 11)
			this.testShaders[11].setUniformsValues({ timeFactor: t / 5000 % 100 });
	}
