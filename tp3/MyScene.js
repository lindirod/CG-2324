...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.pyramid = new MyPyramid(this, 3, 5);
    ...
    initMaterials() {
        ...
        this.material3.setDiffuse(0, 1, 0, 1.0);
        this.material3.setSpecular(1, 0, 0, 1.0);
        this.material3.setShininess(10.0);

        // Wood 
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0.95, 0.87, 0.65, 1.0);
        this.material4.setDiffuse(0, 0, 0, 1.0);
        this.material4.setSpecular(0.2, 0.2, 0, 1.0);
